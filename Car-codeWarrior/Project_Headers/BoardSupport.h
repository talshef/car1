...
//*************************** our  defines********************************************//
#define MUDULO_TPM  9374
#define MIN_PWM_TPM  2920
#define ZeroDegree 213
#define FullDegree 825


//const int  FullDegree  =825;
extern totalEncoderLeft;
extern uint16_t IrSampels[90];
extern totalEncoder;
extern leftIr;
extern rightIr;
extern double BattSamp;
extern sonicCapture;
extern int Irdistance[][136];
extern sonicCounter;
extern double sonicRightDistance;
extern double sonicLeftDistance;
extern adcMux;
extern double carDirection;
extern encouderCounterLeft;
extern encouderCounterRight;
extern state;
extern char maze[][20];
extern pitVal;
extern double x;
